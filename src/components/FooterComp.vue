  ...
  <section :class="colorFooter()">
    <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
      <nav class="flex flex-wrap justify-center -mx-5 -my-2">
        <div class="px-5 py-2">
          <RouterLink to="/sobrenos" :class="colorText()">
            Sobre nós
          </RouterLink>
        </div>
        <div class="px-5 py-2">
          <a href="https://wa.me/5547992877667" target="_blank" :class="colorText()">
            Contato
          </a>
        </div>
        <div class="px-5 py-2">
          <a href="mailto:texsan@texsan.com.br" target="_blank" :class="colorText()">
            Email
          </a>
        </div>
      </nav>
      <div class="flex justify-center mt-8 space-x-6">
        <!-- <a href="#" :class="colorIcon()">
        ...
        <a href="https://www.instagram.com/texsan.saneamento/" target="_blank" :class="colorIcon()">
      ...
      <p class="mt-8 text-base leading-6 text-center text-gray-400">
        © 2023 Texsan, LTDA. Todos os direitos reservados.
      </p>
    </div>
  </section>
</template>
