...
<template>
  <div class="all">
    <div class="flex justify-center">
      <h1
        class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-transparent bg-clip-text bg-gradient-to-l from-emerald-700 via-cyan-800 to-indigo-900 md:text-text-4xl lg:text-7xl"
      >
        O site da Texsan
        <div class="flex justify-center">
          <h1 :class="colorText()">está chegando</h1>
        </div>
      </h1>
    </div>
    <div class="flex justify-center">
      ...
      >
        Em breve o site da texsan estará no ar!
      </p>
    </div>
    <div class="flex justify-center">
      <a
        href="https://wa.me/5547992877667"
        target="_blank"
        :class="colorButton()"
      >
        Saiba mais
